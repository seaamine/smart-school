<template>
    <div class="h-screen flex-wrap  flex justify-center content-center">
        <div class="card p-6">
            <h2 class="text-primary-500 mb-10 text-center font-semibold">Smart School</h2>
            ...
            <form @submit.prevent="submit">
                ...
                <button type="submit" class="w-full	py-3 px-6 rounded-md text-white font-semibold bg-primary-500 border border-primary-500 mr-4 focus:bg-primary-600 focus:outline-none active:bg-primary-600" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">Se connecter</button>
            </form>
        </div>
    </div>
