    ...
    export default {
        ...
        setup(props) {
            const formValues = {
                ...
                dob: new Date(props.student.dob),
                commune: props.student.commune,
                willaya: props.student.willaya,
                paye: props.student.paye,
                email: props.student.email,
                address: props.student.address,
                fatherFirstName: props.student.father_name,
                fatherPhone: props.student.father_phone_no,
