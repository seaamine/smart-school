...
class SubjectsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Subject::create(['name'=>'Géographie','status'=>'1','image_path'=>'images/geography.jpg']);
        Subject::create(['name'=>'Education Islamique','status'=>'1','image_path'=>'images/islamic.jpg']);
        Subject::create(['name'=>'Education Civique','status'=>'1','image_path'=>'images/civic.jpg']);
        ...
        Subject::create(['name'=>'Langue arabe','status'=>'1','image_path'=>'images/arabic.jpg']);
        Subject::create(['name'=>'Langue Tamazight','status'=>'1','image_path'=>'images/amazigh.jpg']);
