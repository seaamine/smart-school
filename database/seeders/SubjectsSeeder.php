...
class SubjectsSeeder extends Seeder
{
    ...
    public function run()
    {
        Subject::create(['name'=>'Histoire','status'=>1]);
        ...
        Subject::create(['name'=>'Mathématiques','status'=>1]);
        Subject::create(['name'=>'Sciences de la nature et de la vie','status'=>1]);
        Subject::create(['name'=>'Sciences physiques et technologiques','status'=>1]);
